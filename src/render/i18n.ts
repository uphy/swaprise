...
const JA: Record<string, string> = {
  ...
  "Up to 3 swaps. Rising is frozen in the preview; wait between moves. This is a found route, not the maximum. Active-chain moves are not searched.": "最大3回の交換を探索します。お手本はせり上がり停止・各手の動きが終わってから次を交換する条件です。最大連鎖の保証ではありません。アクティブ連鎖の操作は探索対象外です。",
  "No route found within the search limit. This does not mean a chain is impossible.": "探索範囲内では連鎖の手順が見つかりませんでした。連鎖が作れないという意味ではありません。",
  "Found {chain}-chain in {moves} swaps. Play the preview, then return to try it.": "{moves}回の交換で{chain}連鎖になる手順が見つかりました。お手本を見て、元の盤面で試してみましょう。",
  "First wait for the current movement to settle.": "まず現在の消去・落下が終わるまで待ちます。",
  "Row {y} from bottom: swap columns {x} and {next}, then wait.": "下から{y}段目、左から{x}列と{next}列を交換し、動きが終わるまで待つ。",
  "Preview complete: {chain}-chain. Your original board is unchanged.": "お手本完了：{chain}連鎖。元の盤面は変更されていません。",
  "Could not search. Return to the game and try again.": "探索できませんでした。ゲームへ戻って、もう一度お試しください。",
  "HINT": "ヒント", "SLOW: OFF": "スロー: オフ", "SLOW: ON": "スロー: オン",
