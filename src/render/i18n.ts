...
const JA: Record<string, string> = {
  ...
  "Your name, score, chain and date will be public. Endless / time attack only. You can change this in settings.": "名前・得点・連鎖・日付が誰でも見られるようになります。対象はエンドレスとタイムアタックだけで、設定からいつでも変えられます。",
