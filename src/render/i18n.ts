...
const JA: Record<string, string> = {
  ...
  "{count} / {total} LESSONS · clear, chain, active chain": "{count} / {total} 課 · 消し方・連鎖・アクティブ連鎖", "all {total} lessons done": "全 {total} 課を終えました",
  ...
  "CLEAR 3": "3 枚そろえる",
  "Line up 3 of the same panel to clear them. Move the lone panel next to the two.": "同じ柄を 3 枚並べると消えます。1 枚だけ離れているパネルを、2 枚の隣へ動かしましょう。",
  "You cleared 3 panels. That is the basic move.": "3 枚消せました。これが基本の動きです。",
  DROP: "落とす",
  "A moved panel falls into a hole. Drop the panel onto the two below it. Vertical lines clear too.": "動かしたパネルは穴に落ちます。上のパネルを、下の 2 枚の上へ落としましょう。縦に並んでも消えます。",
  "Dropping lets you reach panels that are far apart.": "落とせば、離れたパネルもそろえられます。",
  CHAIN: "連鎖",
  "When panels above a clear fall and line up, that is a chain. Clear the three so the panel above lands next to its pair.": "消えた上のパネルが落ちてまたそろうと連鎖です。上に乗ったパネルが 2 枚の隣に落ちるように、3 枚を消しましょう。",
  "A 2-chain. Each extra step scores more and sends more garbage.": "2 連鎖です。連鎖が続くほど得点が増え、相手に送るおじゃまも増えます。",
  COMBO: "同時消し",
  "Clearing 4 or more at once is a combo. Drop the panel into the gap. Combos and chains send garbage to the opponent.": "4 枚以上を一度に消すと同時消しです。パネルを隙間に落としましょう。同時消しと連鎖は相手におじゃまを送ります。",
  "A combo. Big clears send a wide block of garbage.": "同時消しです。大きく消すほど幅の広いおじゃまを送れます。",
  "ACTIVE CHAIN": "アクティブ連鎖",
  "You can swap while panels are flashing. Clear the three, then quickly swap the two on the right before the panels fall.": "パネルが点滅している間も入れ替えられます。3 枚を消したら、上のパネルが落ちる前に右の 2 枚を素早く入れ替えましょう。",
  "That was an active chain. This is how long chains are built.": "アクティブ連鎖です。長い連鎖はこうして作ります。",
  "RISING BOARD": "せり上がる盤面",
  "The board rises on its own. Make a 2-chain. Hold the bar under the board to raise it faster.": "盤面はひとりでにせり上がります。2 連鎖を作りましょう。盤面の下のバーを押すと速く上がります。",
  "The board rises on its own. Make a 2-chain. Hold X to raise it faster.": "盤面はひとりでにせり上がります。2 連鎖を作りましょう。X を押すと速く上がります。",
