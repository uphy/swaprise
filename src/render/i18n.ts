...
const JA: Record<string, string> = {
  ...
  "LESSON {n} / {total}": "レッスン {n} / {total}", "The board changed. RESET puts it back.": "盤面が変わりました。RESET で最初の形に戻します。", "The board reached the top. Try again and make a 2-chain.": "天井に届きました。もう一度、2連鎖を作りましょう。", RESET: "リセット", "NICE!": "できた！", "NEXT LESSON": "次の課へ", "PLAY ENDLESS": "エンドレスで遊ぶ",
